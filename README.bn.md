...
# Package managers
npm i -g novacode-ai@latest        # or bun/pnpm/yarn
scoop install novacode             # Windows
choco install novacode             # Windows
brew install anomalyco/tap/novacode # macOS and Linux (recommended, always up to date)
brew install novacode              # macOS and Linux (official brew formula, updated less)
sudo pacman -S novacode            # Arch Linux (Stable)
paru -S novacode-bin               # Arch Linux (Latest from AUR)
mise use -g novacode               # Any OS
nix run nixpkgs#novacode           # or github:anomalyco/novacode for latest dev branch
```
...
NovaCode ডেস্কটপ অ্যাপ্লিকেশন হিসেবেও উপলব্ধ। সরাসরি [রিলিজ পেজ](https://github.com/anomalyco/novacode/releases) অথবা [novacode.ai/download](https://novacode.ai/download) থেকে ডাউনলোড করুন।
...
4. `$HOME/.novacode/bin` - ডিফল্ট ফলব্যাক
...
NovaCode এ দুটি বিল্ট-ইন এজেন্ট রয়েছে যা আপনি `Tab` কি(key) দিয়ে পরিবর্তন করতে পারবেন।
...
এজেন্টদের সম্পর্কে আরও জানুন: [docs](https://novacode.ai/docs/agents)।

### ডকুমেন্টেশন (Documentation)

কিভাবে NovaCode কনফিগার করবেন সে সম্পর্কে আরও তথ্যের জন্য, [**আমাদের ডকস দেখুন**](https://novacode.ai/docs)।

### অবদান (Contributing)

আপনি যদি NovaCode এ অবদান রাখতে চান, অনুগ্রহ করে একটি পুল রিকোয়েস্ট সাবমিট করার আগে আমাদের [কন্ট্রিবিউটিং ডকস](./CONTRIBUTING.md) পড়ে নিন।

### NovaCode এর উপর বিল্ডিং (Building on NovaCode)

আপনি যদি এমন প্রজেক্টে কাজ করেন যা NovaCode এর সাথে সম্পর্কিত এবং প্রজেক্টের নামের অংশ হিসেবে "novacode" ব্যবহার করেন, উদাহরণস্বরূপ "novacode-dashboard" বা "novacode-mobile", তবে দয়া করে আপনার README তে একটি নোট যোগ করে স্পষ্ট করুন যে এই প্রজেক্টটি NovaCode দল দ্বারা তৈরি হয়নি এবং আমাদের সাথে এর কোনো সরাসরি সম্পর্ক নেই।

---

**আমাদের কমিউনিটিতে যুক্ত হোন** [Discord](https://discord.gg/novacode) | [X.com](https://x.com/novacode)
