...
Desktop application and browser-based app issues, including `novacode web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core novacode server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

NovaCode Zen, NovaCode Go, and billing issues.
