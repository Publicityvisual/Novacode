...
- PR #13942: https://github.com/anomalyco/novacode/pull/13942

## Do Not Translate (Locale Additions)

- `NovaCode` (preserve casing in prose; keep `novacode` only when it is part of commands, package names, paths, or code)
- `NovaCode Zen`
- `NovaCode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `novacode` in prose when referring to the product name; use `NovaCode`
