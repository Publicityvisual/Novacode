...
- PR #10809: https://github.com/anomalyco/novacode/pull/10809
- PR #11496: https://github.com/anomalyco/novacode/pull/11496

## Do Not Translate (Locale Additions)

- `NovaCode` (preserve casing in prose; keep `novacode` only in commands, package names, paths, or code)
- `NovaCode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
