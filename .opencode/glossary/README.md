...
Use this folder for locale-specific translation guidance that supplements `.novacode/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/novacode/pull/12345

## Do Not Translate (Locale Additions)

- `NovaCode` (preserve casing)
