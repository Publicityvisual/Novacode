...
- PR #15835: https://github.com/anomalyco/novacode/pull/15835

## Do Not Translate (Locale Additions)

- `NovaCode` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `novacode` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `NovaCode` in prose, `novacode` only for exact technical identifiers
...
- Avoid changing `novacode` to `NovaCode` inside commands, URLs, package names, or code literals
