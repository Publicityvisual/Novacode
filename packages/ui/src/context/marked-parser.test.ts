...
test("renders links with application attributes", async () => {
  expect(await parser.parse("[NovaCode](https://novacode.ai)")).toBe(
    '<p><a href="https://novacode.ai" class="external-link" target="_blank" rel="noopener noreferrer">NovaCode</a></p>\n',
  )
})
