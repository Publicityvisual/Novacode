...
Utwórz `.novacode/commands/test.md`:
...
Możesz zdefiniować polecenia w `novacode.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji novacode:
...
- Globalnie: `~/.config/novacode/commands/`
- Na projekt: `.novacode/commands/`
...
novacode zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
