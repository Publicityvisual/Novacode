---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala novacode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

novacode zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie novacode uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI novacode, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do novacode. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij novacode. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `novacode.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo NovaCode czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `novacode.default`.
