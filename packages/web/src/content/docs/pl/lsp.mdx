---
title: Serwery LSP
description: NovaCode integruje się z serwerami LSP.
---

NovaCode może integrować się z serwerami Language Server Protocol (LSP), aby używać diagnostyki jako informacji zwrotnej dla agenta.

---

## Wbudowane

NovaCode posiada kilka wbudowanych serwerów LSP dla następujących języków:
...
Gdy LSP jest włączony i NovaCode otwiera plik:
...
Możesz włączać i dostosowywać serwery LSP poprzez sekcję `lsp` w konfiguracji NovaCode.
