---
title: LSP Servers
description: NovaCode integrates with your LSP servers.
---

NovaCode can integrate with Language Server Protocol (LSP) servers to use diagnostics as feedback for the agent.

---

## Built-in

NovaCode comes with several built-in LSP servers for popular languages:
...
When LSP is enabled and novacode opens a file, it:
...
You can enable and customize LSP servers through the `lsp` section in your novacode config.
