---
title: Teilen
description: Teile NovaCode-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu NovaCode-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht NovaCode Folgendes:
...
NovaCode hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt NovaCode den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`novacode.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du novacode in deiner Organisation einsetzt.
