---
title: LSP Server
description: NovaCode lässt sich in Ihren LSP-Server integrieren.
---

NovaCode kann sich in Language Server Protocol (LSP)-Server integrieren, um Diagnosen als Feedback für den Agenten zu verwenden.

---

## Integriert

NovaCode verfügt über mehrere integrierte LSP-Server für gängige Sprachen:
...
Wenn LSP aktiviert ist und NovaCode eine Datei öffnet, geschieht Folgendes:
...
Sie können LSP-Server über den Abschnitt `lsp` in Ihrer NovaCode-Konfiguration aktivieren und anpassen.
