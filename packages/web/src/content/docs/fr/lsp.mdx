---
title: Serveurs LSP
description: NovaCode s'intègre à vos serveurs LSP.
---

NovaCode peut s'intégrer aux serveurs Language Server Protocol (LSP) pour utiliser les diagnostics comme retour pour l'agent.

---

## Serveurs intégrés

NovaCode est livré avec plusieurs serveurs LSP intégrés pour les langages populaires :
...
Lorsque LSP est activé et qu'novacode ouvre un fichier, il :
...
Vous pouvez activer et personnaliser les serveurs LSP via la section `lsp` de votre configuration novacode.
