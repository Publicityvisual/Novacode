---
title: Server LSP
description: NovaCode si integra con i tuoi server LSP.
---

NovaCode può integrarsi con server Language Server Protocol (LSP) per usare la diagnostica come feedback per l'agente.

---

## Integrati

NovaCode include diversi server LSP integrati per linguaggi popolari:
...
Quando LSP è abilitato e novacode apre un file:
...
Puoi abilitare e personalizzare i server LSP tramite la sezione `lsp` nella configurazione di novacode.
