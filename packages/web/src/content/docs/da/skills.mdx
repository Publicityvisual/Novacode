...
Agentferdigheter lar NovaCode oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går NovaCode opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
NovaCode viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `novacode.json`:
