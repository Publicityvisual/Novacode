---
title: TUI
description: Brug af NovaCode-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

NovaCode giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre NovaCode starter TUI for den nuværende mappe.
...
Når du bruger NovaCode TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til NovaCode. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut NovaCode. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `novacode.json`, som konfigurerer server-/kørselstidsadfærd.
...
- `leader_timeout` - Styrer hvor længe NovaCode venter efter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID der skal bruges. Standard er `novacode.default`.
