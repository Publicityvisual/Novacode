---
title: LSP-servere
description: NovaCode integreres med dine LSP-servere.
---

NovaCode kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

NovaCode leveres med flere indbyggede LSP-servere til populære sprog:
...
Når LSP er aktiveret, og novacode åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din novacode-konfiguration.
