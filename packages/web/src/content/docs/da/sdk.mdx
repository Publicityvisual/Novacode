...
Brug den til at bygge integrasjoner og kontrollere novacode programmatisk.
...
Opret en forekomst av novacode:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `novacode.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av novacode, kan du oprete en klientforekomst for at koble til den:
