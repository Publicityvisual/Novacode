...
Opret `.novacode/commands/test.md`:
...
Du kan tilføje brugerdefinerede kommandoer gennem NovaCode-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din NovaCode [config](/docs/config):
...
- Globalt: `~/.config/novacode/commands/`
- Pr. projekt: `.novacode/commands/`
...
novacode indeholder flere indbyggede kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
