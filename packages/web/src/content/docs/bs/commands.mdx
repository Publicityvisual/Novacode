...
Kreiraj `.novacode/commands/test.md`:
...
Možete dodati prilagođene komande kroz NovaCode konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom NovaCode [config](/docs/config):
...
- Globalno: `~/.config/novacode/commands/`
- Po projektu: `.novacode/commands/`
...
NovaCode uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
