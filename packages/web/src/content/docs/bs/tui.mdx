---
title: TUI
description: Korištenje korisničkog interfejsa NovaCode terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

NovaCode pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje NovaCode pokreće TUI za trenutni direktorij.
...
Kada koristite NovaCode TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u NovaCode. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz NovaCode. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `novacode.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo NovaCode čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `novacode.default`.
