---
title: خوادم LSP
description: يتكامل NovaCode مع خوادم LSP لديك.
---

يمكن أن يتكامل NovaCode مع خوادم Language Server Protocol (LSP) لاستخدام التشخيصات كملاحظات للوكيل.

---

## المدمجة

يأتي NovaCode مع عدة خوادم LSP مدمجة للغات الشائعة:
...
عند تفعيل LSP وفتح novacode لملف، فإنه:
...
يمكنك تفعيل خوادم LSP وتخصيصها عبر قسم `lsp` في إعدادات novacode.
