...
สร้าง `.novacode/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ NovaCode:
...
- ระดับผู้ใช้ (Global): `~/.config/novacode/commands/`
- ระดับโปรเจ็กต์: `.novacode/commands/`
...
NovaCode มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
