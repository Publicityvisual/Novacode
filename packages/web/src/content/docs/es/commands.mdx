...
Crear `.novacode/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración NovaCode o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su NovaCode [config](/docs/config):
...
- Por proyecto: `.novacode/commands/`
...
novacode incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
