...
Opprett `.novacode/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom NovaCode-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i NovaCode [config](/docs/config):
...
- Per prosjekt: `.novacode/commands/`
...
NovaCode inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
