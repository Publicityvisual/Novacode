---
title: LSP-servere
description: novacode integreres med LSP-serverne dine.
---

NovaCode kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.

---

## Innebygde servere

NovaCode kommer med flere innebygde LSP-servere for populære språk:
...
Når LSP er aktivert og novacode åpner en fil, gjør den:
...
Du kan aktivere og tilpasse LSP-servere gjennom `lsp`-delen i NovaCode-konfigurasjonen.
