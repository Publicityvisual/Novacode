---
title: TUI
description: Bruke novacode-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

NovaCode gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre NovaCode starter TUI for gjeldende katalog.
...
Når du bruker NovaCode TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til NovaCode. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt NovaCode. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `novacode.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge NovaCode venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `novacode.default`.
