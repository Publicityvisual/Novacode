---
title: Özel Araçlar
description: LLM'un novacode'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. novacode'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.novacode/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/novacode/tools/` içine yerleştirerek.
