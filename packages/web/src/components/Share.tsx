...
import type { MessageV2 } from "novacode/session/message-v2"
import type { Message } from "novacode/session/message"
import type { Session } from "novacode/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.novacode_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.novacode_name}>
