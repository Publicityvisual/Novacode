...
import { showToast } from "@novacode-ai/ui/toast"
import { ButtonV2 } from "@novacode-ai/ui/v2/button-v2"
import { Dialog, DialogBody, DialogFooter, DialogHeader, DialogTitle } from "@novacode-ai/ui/v2/dialog-v2"
import { DividerV2 } from "@novacode-ai/ui/v2/divider-v2"
import { LoaderV2 } from "@novacode-ai/ui/v2/loader-v2"
import { RadioGroupV2, RadioItemV2 } from "@novacode-ai/ui/v2/radio-v2"
...
function useWslAddServerController(props: DialogWslServerProps) {
  ...
  const runPrimary = async () => {
    ...
    if (action === "install-novacode") {
      await run(() => api.installNovaCode(distro))
      return
    }
