...
export const dict = {
  ...
  "dialog.provider.novacode.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.novacode.tagline": "Reliable optimized models",
  "dialog.provider.novacodeGo.tagline": "Low cost subscription for everyone",
  ...
  "provider.connect.novacodeZen.visit.prefix": "Visit ",
  "provider.connect.novacodeZen.visit.link": "novacode.ai/zen",
  "provider.connect.novacodeZen.visit.suffix": " to collect your API key.",
  ...
  "wsl.onboarding.novacodeReadyIn": "NovaCode is ready in {{distro}}.",
  "wsl.onboarding.novacodeReady": "NovaCode is ready.",
  ...
  "wsl.onboarding.distroStatus.novacodeMissing": "NovaCode not installed",
