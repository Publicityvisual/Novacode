...
beforeAll(async () => {
  ...
  mock.module("@novacode-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@novacode-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@novacode-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@novacode-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
