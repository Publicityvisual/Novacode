...
const PROVIDER_NOTES = [
  { match: (id: string) => id === "novacode", key: "dialog.provider.novacode.note" },
  { match: (id: string) => id === "novacode-go", key: "dialog.provider.novacodeGo.tagline" },
...
export const SettingsProvidersV2: Component<{
  ...
  const connected = createMemo(() => {
    return providers
      .connected()
      .filter((p) => p.id !== "novacode" || Object.values(p.models).find((m) => m.cost?.input))
  })
                  ...
                  <div class="settings-v2-provider-lead">
                    ...
                    <div class="settings-v2-provider-copy">
                      <div class="settings-v2-provider-main">
                        ...
                        <Show when={item.id === "novacode" || item.id === "novacode-go"}>
