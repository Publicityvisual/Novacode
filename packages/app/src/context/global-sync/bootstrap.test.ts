...
import type { Config, OpencodeClient, Project } from "@novacode-ai/sdk/v2/client"
import type { AgentApi, CatalogApi, CommandApi, ReferenceApi } from "@novacode-ai/client/promise"
import type { NormalizedProviderListResponse } from "@novacode-ai/session-ui/context"
import {
  bootstrapDirectory,
  loadAgentsQuery,
  loadCommands,
