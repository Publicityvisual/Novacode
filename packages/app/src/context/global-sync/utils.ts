import type {
  ...
  PermissionV2Request,
  ProviderListOutput,
} from "@novacode-ai/client/promise"
import type { Agent, PermissionRequest, Project, Provider, ProviderListResponse } from "@novacode-ai/sdk/v2/client"
import type { Project as CurrentProject } from "@novacode-ai/client/promise"
import { NormalizedProviderListResponse } from "@novacode-ai/session-ui/context"
