  ...
  test("moves an existing canonical web bucket into local scope", () => {
    expect(
      migrateCanonicalLocalServerState(
        {
          list: [],
          projects: { "https://novacode.example.com": [{ worktree: "/remote", expanded: true }] },
          lastProject: { "https://novacode.example.com": "/remote" },
        },
        ServerConnection.Key.make("https://novacode.example.com"),
      ),
    ).toEqual({
      list: [],
      ...
      migrateCanonicalLocalServerState(
        {
          projects: {
            ...
            "https://novacode.example.com": [
              { worktree: "/local", expanded: true },
              { worktree: "/remote", expanded: true },
            ],
          },
          lastProject: { local: "/local", "https://novacode.example.com": "/remote" },
        },
        ServerConnection.Key.make("https://novacode.example.com"),
      ),
    ).toEqual({
