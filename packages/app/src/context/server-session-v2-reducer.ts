import type { NovaCodeEvent, SessionMessageInfo, SessionPendingMessage } from "@novacode-ai/client/promise"
...
export function createV2SessionReducer() {
  ...
  const reduce = (source: readonly SessionMessageInfo[], event: NovaCodeEvent): V2SessionReduction | undefined => {
