import type { NovaCodeEvent } from "@novacode-ai/client/promise"
import type { Event } from "@novacode-ai/sdk/v2/client"
...
export type ServerEvent = Event & { current?: NovaCodeEvent }
...
export function adaptServerEvent(event: NovaCodeEvent): ServerEvent {
...
function currentDelta(event: NovaCodeEvent | undefined): CurrentDelta | undefined {
  if (
