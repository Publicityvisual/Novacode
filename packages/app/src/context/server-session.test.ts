...
import type { retry } from "@novacode-ai/core/util/retry"
import type { NovaCodeEvent, SessionApi } from "@novacode-ai/client/promise"
import type { Message, OpencodeClient, Part, Session } from "@novacode-ai/sdk/v2/client"
...
describe("server session", () => {
  test("projects V2 session events into current and legacy message state", () => {
    ...
    const apply = (input: object) => ctx.store.applyV2(input as NovaCodeEvent)
