...
import defaultSoundPath from "@novacode-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@novacode-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@novacode-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@novacode-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@novacode-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@novacode-ai/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_PACK_ID = "novacode.default"
