...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/novacode.git")).toEqual({ owner: "sst", repo: "novacode" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/novacode")).toEqual({ owner: "sst", repo: "novacode" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/novacode.git")).toEqual({ owner: "sst", repo: "novacode" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/novacode")).toEqual({ owner: "sst", repo: "novacode" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/novacode.git")).toEqual({ owner: "sst", repo: "novacode" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/novacode")).toEqual({ owner: "sst", repo: "novacode" })
})
