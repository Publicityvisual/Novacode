...
describe("novacode read-only commands (smoke)", () => {
  ...
  cliIt.live(
    ...
    ({ novacode }) =>
      Effect.gen(function* () {
        const r = yield* novacode.spawn(["mcp", "list"])
        novacode.expectExit(r, 0, "mcp list")
      }),
    60_000,
  )
  ...
  cliIt.live(
    ...
    ({ novacode }) =>
      Effect.gen(function* () {
        const r = yield* novacode.spawn(["providers", "list"])
        novacode.expectExit(r, 0, "providers list")
  ...
  cliIt.live(
    ...
    ({ novacode }) =>
      Effect.gen(function* () {
        const r = yield* novacode.spawn(["models"])
        novacode.expectExit(r, 0, "models")
  ...
  cliIt.live(
    ...
    ({ novacode }) =>
      Effect.gen(function* () {
        const r = yield* novacode.spawn(["agent", "list"])
        novacode.expectExit(r, 0, "agent list")
      }),
    60_000,
  )
  ...
  cliIt.live(
    ...
    ({ novacode }) =>
      Effect.gen(function* () {
        const r = yield* novacode.spawn(["session", "list"])
        novacode.expectExit(r, 0, "session list")
      }),
    60_000,
  )
  ...
  cliIt.live(
    ...
    ({ novacode }) =>
      Effect.gen(function* () {
        const r = yield* novacode.spawn(["stats"])
        novacode.expectExit(r, 0, "stats")
      }),
    60_000,
  )
  ...
  cliIt.live(
    ...
    ({ novacode }) =>
      Effect.gen(function* () {
        const r = yield* novacode.spawn(["db", "path"])
        novacode.expectExit(r, 0, "db path")
