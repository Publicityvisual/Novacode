...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips novacode-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-novacode-directory"]).toBeUndefined()
      expect(forwarded["x-novacode-workspace"]).toBeUndefined()
