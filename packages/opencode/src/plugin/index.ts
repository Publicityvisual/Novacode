...
import { gitlabAuthPlugin as GitlabAuthPlugin } from "novacode-gitlab-auth"
import { PoeAuthPlugin } from "novacode-poe-auth"
...
export class Service extends Context.Service<Service, Interface>()("@novacode/Plugin") {}
