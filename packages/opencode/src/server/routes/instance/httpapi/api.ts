...
import { makeApi } from "@novacode-ai/protocol/api"
import { LocationMiddleware } from "@novacode-ai/server/location"
import { SessionLocationMiddleware } from "@novacode-ai/server/middleware/session-location"
...
export const RootHttpApi = HttpApi.make("novacode-root")
...
export const InstanceHttpApi = HttpApi.make("novacode-instance")
...
export const NovaCodeHttpApi = HttpApi.make("novacode")
