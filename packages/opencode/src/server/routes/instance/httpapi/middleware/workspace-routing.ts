...
>()("@novacode/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@novacode/ExperimentalHttpApiWorkspaceRouting") {}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-novacode-directory"] || process.cwd()
}
