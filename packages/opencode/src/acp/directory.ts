...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@novacode/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@novacode/ACPDirectory") {}
