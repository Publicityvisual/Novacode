...
import type * as SDK from "@novacode-ai/sdk/v2"
...
import { SessionShareTable } from "@novacode-ai/core/share/sql"
...
export class Service extends Context.Service<Service, Interface>()("@novacode/ShareNext") {}
