...
import { AbsolutePath, type DeepMutable } from "@novacode-ai/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@novacode/Agent") {}
          ...
          plan: {
            ...
            permission: Permission.merge(
              ...
              Permission.fromConfig({
                ...
                edit: {
                  "*": "deny",
                  [path.join(".novacode", "plans", "*.md")]: "allow",
