...
import { AccountStateTable, AccountTable } from "@novacode-ai/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@novacode/AccountRepo") {}
