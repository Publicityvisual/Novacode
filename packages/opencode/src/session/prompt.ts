...
import { MAX_STEPS_PROMPT } from "@novacode-ai/core/session/runner/max-steps"
...
import { LLMEvent } from "@novacode-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@novacode/SessionPrompt") {}
