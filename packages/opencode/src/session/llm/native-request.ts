import type { JsonSchema, LLMRequest, ProviderMetadata } from "@novacode-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@novacode-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @novacode-ai/llm request objects from novacode's session/AI SDK-shaped data.
  return LLM.request({
