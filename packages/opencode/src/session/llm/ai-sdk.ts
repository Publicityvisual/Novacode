import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@novacode-ai/llm"
...
// Move this extraction into @novacode-ai/llm when Copilot is handled by the native runtime.
