...
import { Slug } from "@novacode-ai/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@novacode-ai/llm"
...
import { locationServiceMapLayer } from "@novacode-ai/core/location-services"
...
import { PartTable, SessionTable } from "@novacode-ai/core/session/sql"
...
import { NonNegativeInt, optional } from "@novacode-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".novacode", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@novacode/Session") {}
