...
import { buildPrompt } from "@novacode-ai/core/session/compaction"
import { SessionCompactionEvent } from "@novacode-ai/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@novacode/SessionCompaction") {}
