...
import { EventSequenceTable, EventTable } from "@novacode-ai/core/event/sql"
...
import { WorkspaceEvent } from "@novacode-ai/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@novacode/Workspace") {}
