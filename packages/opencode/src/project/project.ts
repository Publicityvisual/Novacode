...
import { ProjectDirectoryTable, ProjectTable } from "@novacode-ai/core/project/sql"
import { ProjectDirectories } from "@novacode-ai/core/project/directories"
...
import { which } from "@novacode-ai/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@novacode/Project") {}
