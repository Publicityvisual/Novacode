// Shared type vocabulary for the direct interactive mode (`novacode --mini`).
//
...
import type { OpencodeClient, PermissionRequest, QuestionRequest, ToolPart } from "@novacode-ai/sdk/v2"
