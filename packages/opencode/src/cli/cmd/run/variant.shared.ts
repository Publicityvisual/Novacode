...
//
// The saved variant persists across sessions in ~/.local/state/novacode/model.json
...
class Service extends Context.Service<Service, VariantService>()("@novacode/RunVariant") {}
