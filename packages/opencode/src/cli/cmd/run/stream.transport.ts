...
import type { Event, GlobalEvent, OpencodeClient } from "@novacode-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@novacode/RunStreamTransport") {}
