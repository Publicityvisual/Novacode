...
Practical reference for the current tool-migration state in `packages/novacode`.
...
Tool tests should use the existing Effect helpers in `packages/novacode/test/lib/effect.ts`:
