...
Concrete inventory of the remaining `makeRuntime(...)`-backed facades in `packages/novacode`.
...
- [x] `../core/src/filesystem.ts` (`FileSystem`) - legacy novacode service removed
