...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@novacode-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@novacode/v2/ToolRegistry") {}
