...
import { PermissionSaved } from "@novacode-ai/schema/permission-saved"
...
export class Service extends Context.Service<Service, Interface>()("@novacode/v2/PermissionSaved") {}
