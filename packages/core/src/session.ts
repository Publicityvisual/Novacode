...
import { ListAnchor } from "@novacode-ai/schema/session"
...
import { SessionDurable } from "@novacode-ai/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@novacode/v2/Session") {}
