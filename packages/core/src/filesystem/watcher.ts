...
import { FileSystemWatcher } from "@novacode-ai/schema/filesystem-watcher"
...
export class Service extends Context.Service<Service, Interface>()("@novacode/v2/FileWatcher") {}
