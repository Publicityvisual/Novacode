...
import type { Data, Definition, Payload } from "@novacode-ai/schema/event"
...
import { Durable } from "@novacode-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@novacode-ai/schema/event").ID
export type { Data, Definition, Payload } from "@novacode-ai/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@novacode/Event") {}
