...
import type { EffectDrizzleSqlite } from "@novacode-ai/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@novacode/ProjectDirectories") {}
