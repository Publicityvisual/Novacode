...
import type { Plugin as PluginRuntime } from "@novacode-ai/plugin/v2/effect"
...
export class Service extends Context.Service<Service, Interface>()("@novacode/v2/Plugin") {}
