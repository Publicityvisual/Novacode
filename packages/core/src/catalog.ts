...
import { Catalog } from "@novacode-ai/schema/catalog"
...
export class Service extends Context.Service<Service, Interface>()("@novacode/v2/Catalog") {}
    ...
    const result: Interface = {
      ...
      model: {
        ...
        small: Effect.fn("CatalogV2.model.small")(function* (providerID) {
          ...
          if (providerID === ProviderV2.ID.novacode) {
