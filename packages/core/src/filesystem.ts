...
import { Entry, FileSystem, FindInput, Match } from "@novacode-ai/schema/filesystem"
export { Entry, Match, Submatch } from "@novacode-ai/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@novacode/v2/FileSystem") {}
