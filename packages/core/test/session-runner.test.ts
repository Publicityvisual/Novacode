...
import {
  ...
  type LLMClientShape,
  type LLMRequest,
} from "@novacode-ai/llm"
import * as OpenAIChat from "@novacode-ai/llm/protocols/openai-chat"
import { Database } from "@novacode-ai/core/database/database"
import { makeLocationNode } from "@novacode-ai/core/effect/app-node"
...
import { PermissionV2 } from "@novacode-ai/core/permission"
import { EventTable } from "@novacode-ai/core/event/sql"
import { Project } from "@novacode-ai/core/project"
import { ProjectTable } from "@novacode-ai/core/project/sql"
import { QuestionV2 } from "@novacode-ai/core/question"
import { AbsolutePath } from "@novacode-ai/core/schema"
import { SessionV2 } from "@novacode-ai/core/session"
import { Snapshot } from "@novacode-ai/core/snapshot"
import { ContextSnapshotDecodeError } from "@novacode-ai/core/session/error"
import { SessionEvent } from "@novacode-ai/core/session/event"
import { SessionInput } from "@novacode-ai/core/session/input"
import { SessionMessage } from "@novacode-ai/core/session/message"
import { Prompt } from "@novacode-ai/core/session/prompt"
import { SessionProjector } from "@novacode-ai/core/session/projector"
import { SessionExecution } from "@novacode-ai/core/session/execution"
import { SessionRunCoordinator } from "@novacode-ai/core/session/run-coordinator"
import { SessionRunner } from "@novacode-ai/core/session/runner"
import * as SessionRunnerLLM from "@novacode-ai/core/session/runner/llm"
import { SessionRunnerModel } from "@novacode-ai/core/session/runner/model"
import { ToolRegistry } from "@novacode-ai/core/tool/registry"
import { ApplicationTools } from "@novacode-ai/core/tool/application-tools"
import { AgentV2 } from "@novacode-ai/core/agent"
import { Config } from "@novacode-ai/core/config"
import { ConfigCompaction } from "@novacode-ai/core/config/compaction"
import { Tool } from "@novacode-ai/core/tool/tool"
import {
  SessionContextEpochTable,
  SessionInputTable,
  SessionMessageTable,
  SessionTable,
} from "@novacode-ai/core/session/sql"
import { SessionStore } from "@novacode-ai/core/session/store"
import { SystemContext } from "@novacode-ai/core/system-context"
import { SystemContextRegistry } from "@novacode-ai/core/system-context/registry"
import { SkillGuidance } from "@novacode-ai/core/skill/guidance"
import { ReferenceGuidance } from "@novacode-ai/core/reference/guidance"
