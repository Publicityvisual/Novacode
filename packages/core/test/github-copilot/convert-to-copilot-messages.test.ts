import { convertToOpenAICompatibleChatMessages as convertToCopilotMessages } from "@novacode-ai/core/github-copilot/chat/convert-to-openai-compatible-chat-messages"
