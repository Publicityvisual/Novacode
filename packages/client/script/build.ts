...
import { compile, emitEffectImported, emitPromise, write } from "@novacode-ai/httpapi-codegen"
    ...
    [
      write(
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              name: "NovaCodeEventEncoded",
              import: 'import type { NovaCodeEventEncoded } from "@novacode-ai/protocol/groups/event"',
            },
          },
        }),
