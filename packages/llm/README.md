...
Schema-first LLM core for novacode. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@novacode-ai/llm"
import { OpenAI } from "@novacode-ai/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@novacode-ai/llm/providers"
