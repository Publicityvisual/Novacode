...
> current private `@novacode-ai/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@novacode-ai/ai`
...
- Secondary audience: NovaCode and other durable agent runtimes
...
import { LLM } from "@novacode-ai/ai"
import { OpenAI } from "@novacode-ai/ai/providers/openai"
...
```ts
import { Message } from "@novacode-ai/ai"
...
import { LLM, Tool } from "@novacode-ai/ai"
...
NovaCode and other durable runtimes need to own persistence, tool settlement,
...
```ts
import { LLM } from "@novacode-ai/ai/promise"
import { OpenAI } from "@novacode-ai/ai/providers/openai"
...
```ts
import { LLMSchema } from "@novacode-ai/ai/schema"
...
```ts
import { Provider, Protocol } from "@novacode-ai/ai/provider"
...
@novacode-ai/ai/promise
  Promise/AsyncIterable LLM facade

@novacode-ai/ai/schema
  serializable domain schemas

@novacode-ai/ai/provider
  experimental Provider and Protocol authoring APIs

@novacode-ai/ai/providers/openai
@novacode-ai/ai/providers/anthropic
@novacode-ai/ai/providers/google
...
```
...
| Current                                 | Proposed                                                    |
| --------------------------------------- | ----------------------------------------------------------- |
| `@novacode-ai/llm`                      | `@novacode-ai/ai`                                           |
...
NovaCode should migrate to `generateTurn` / `streamTurn`, preserving its durable
