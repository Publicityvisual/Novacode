export const dict = {
  "app.title": "Rankingi użycia modeli AI | NovaCode Data",
  "app.description":
    "Przeglądaj użycie NovaCode w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny NovaCode Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę NovaCode na GitHub",
  "header.github": "GitHub",
  "header.tryNovaCode": "Wypróbuj NovaCode",
  ...
  "footer.homeAria": "Strona główna NovaCode",
  ...
  "home.topModelsDescription": "Użycie modeli w NovaCode.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy NovaCode według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | NovaCode Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w NovaCode, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia NovaCode.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w NovaCode",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia NovaCode",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów NovaCode z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | NovaCode Data",
  "model.description":
    "Zobacz dane użycia {{model}} w NovaCode, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie NovaCode pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu NovaCode z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu NovaCode z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia NovaCode w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny NovaCode, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia NovaCode.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów NovaCode w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy NovaCode w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji NovaCode.",
  ...
  "model.noGeoDescription": "Żadne wiersze geograficzne NovaCode nie pasowały do tego modelu.",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów NovaCode.",
