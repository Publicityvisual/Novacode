export const dict = {
  "app.title": "Classifiche di utilizzo dei modelli IA | NovaCode Data",
  "app.description":
    "Esplora l'utilizzo di NovaCode nei modelli IA, inclusi volume di token, classifiche, quota di mercato, prezzi dei token, costo per sessione, rapporto cache e ripartizioni geografiche.",
  "app.unfurlAlt": "Logotipo NovaCode Data su uno sfondo scuro con motivo",
  ...
  "header.githubAria": "Aggiungi una stella a NovaCode su GitHub",
  "header.github": "GitHub",
  "header.tryNovaCode": "Prova NovaCode",
  ...
  "home.topModelsDescription": "Utilizzo dei modelli in NovaCode.",
  ...
  "home.uniqueUsersDescription": "Utenti unici giornalieri di NovaCode per modello.",
  ...
  "lab.title": "Utilizzo e classifiche dei modelli IA {{lab}} | NovaCode Data",
  "lab.description":
    "Confronta i modelli {{lab}} usati in NovaCode, inclusi utilizzo dei token, classifiche dei modelli, finestre di contesto, date di rilascio, costi e dati specifici del modello.",
  "lab.loadingTitle": "Laboratorio modelli",
  "lab.loadingDescription": "Lettura della disponibilità dei modelli e dell'utilizzo recente di NovaCode.",
  "lab.notFound": "Nessun modello corrispondeva a questo laboratorio.",
  "lab.heroPrefix": "Esplora {{count}} modelli {{lab}} usati in NovaCode",
  ...
  "lab.shareOfUsage": "{{share}} dell'utilizzo recente di NovaCode",
  "lab.usageTitle": "Utilizzo token {{lab}}",
  "lab.usageDescription": "Volume giornaliero di token NovaCode negli ultimi due mesi.",
  ...
  "lab.usage": "Utilizzo",
  "lab.share": "Quota",
  "model.title": "Utilizzo, costo e posizione di {{model}} | NovaCode Data",
  "model.description":
    "Visualizza i dati di utilizzo di {{model}} in NovaCode, inclusi volume di token, rango settimanale, mix di token, costi, rapporto cache, sessioni, ripartizioni geografiche e modelli simili.",
  ...
  "model.catalogFallback":
    "Fatti del modello dall'indice condiviso dei modelli. L'utilizzo di NovaCode appare quando questo modello ha attività.",
  "model.unranked": "Non classificato nell'utilizzo NovaCode della scorsa settimana",
  "model.ranked": "Posizione #{{rank}} nell'utilizzo NovaCode della scorsa settimana",
  ...
  "model.noCurrentUsage": "Nessun utilizzo di NovaCode nella finestra dati attuale.",
  ...
  "model.inputs": "Input",
  "model.overviewDescription": "Token recenti di NovaCode, utenti unici e posizione di mercato.",
  "model.noSummaryTitle": "Nessun riepilogo di utilizzo",
  "model.noSummaryDescription": "Questo modello non ha ancora righe di utilizzo di NovaCode.",
  "model.tokens": "Token",
  ...
  "model.usageDescription": "Volume giornaliero di token NovaCode nella recente finestra di due mesi.",
  ...
  "model.usersDescription": "Utenti unici giornalieri di NovaCode nella recente finestra di due mesi.",
  ...
  "model.efficiencyDescription": "Costi, comportamento della cache e forma media della sessione NovaCode.",
  ...
  "model.noGeoDescription": "Nessuna riga geografica NovaCode corrispondeva a questo modello.",
  "model.peersDescription": "Modelli vicini per volume recente di token NovaCode.",
