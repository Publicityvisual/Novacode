export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | NovaCode Data",
  "app.description":
    "NovaCode kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde NovaCode Data logosu",
  ...
  "header.githubAria": "GitHub'da NovaCode'a yıldız ver",
  "header.github": "GitHub",
  "header.tryNovaCode": "NovaCode'u dene",
  ...
  "footer.homeAria": "NovaCode ana sayfası",
  ...
  "home.topModelsDescription": "NovaCode genelinde model kullanımı.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz NovaCode kullanıcıları.",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | NovaCode Data",
  "lab.description":
    "NovaCode'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  "lab.loadingTitle": "Model Laboratuvarı",
  "lab.loadingDescription": "Model kullanılabilirliği ve son NovaCode kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "NovaCode'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son NovaCode kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük NovaCode token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | NovaCode Data",
  "model.description":
    "{{model}} için NovaCode kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda NovaCode kullanımı görünür.",
  "model.unranked": "Geçen haftaki NovaCode kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki NovaCode kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde NovaCode kullanımı yok.",
  ...
  "model.overviewDescription": "Son NovaCode tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz NovaCode kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük NovaCode token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz NovaCode kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama NovaCode oturum yapısı.",
  ...
  "model.noGeoDescription": "Bu modelle eşleşen NovaCode coğrafi satırı yok.",
  "model.peersDescription": "Son NovaCode token hacmine göre yakındaki modeller.",
