export const dict = {
  "app.title": "Ranking de uso de modelos de IA | NovaCode Data",
  "app.description":
    "Explore o uso do NovaCode em modelos de IA, incluindo volume de tokens, rankings, participação de mercado, preço por token, custo por sessão, taxa de cache e distribuição geográfica.",
  "app.unfurlAlt": "Logotipo do NovaCode Data sobre um fundo escuro padronizado",
  ...
  "header.githubAria": "Dar estrela ao NovaCode no GitHub",
  "header.github": "GitHub",
  "header.tryNovaCode": "Experimente o NovaCode",
  ...
  "footer.homeAria": "Início do NovaCode",
  ...
  "modal.title": "Newsletter do NovaCode",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos no NovaCode.",
  ...
  "home.uniqueUsersDescription": "Usuários únicos diários do NovaCode por modelo.",
  ...
  "lab.title": "Uso e ranking de modelos de IA da {{lab}} | NovaCode Data",
  "lab.description":
    "Compare modelos da {{lab}} usados no NovaCode, incluindo uso de tokens, ranking de modelos, janelas de contexto, datas de lançamento, custos e dados específicos de cada modelo.",
  "lab.loadingTitle": "Laboratório de modelos",
  "lab.loadingDescription": "Lendo disponibilidade de modelos e uso recente do NovaCode.",
  "lab.notFound": "Nenhum modelo correspondeu a este laboratório.",
  "lab.heroPrefix": "Explore {{count}} modelos da {{lab}} usados no NovaCode",
  ...
  "lab.shareOfUsage": "{{share}} do uso recente do NovaCode",
  "lab.usageTitle": "Uso de tokens da {{lab}}",
  "lab.usageDescription": "Volume diário de tokens do NovaCode nos últimos dois meses.",
  ...
  "model.title": "Uso, custo e posição de {{model}} | NovaCode Data",
  "model.description":
    "Veja dados de uso de {{model}} no NovaCode, incluindo volume de tokens, ranking semanal, combinação de tokens, custos, taxa de cache, sessões, distribuição geográfica e modelos pares.",
  ...
  "model.catalogFallback":
    "Fatos do modelo do índice compartilhado de modelos. O uso no NovaCode aparece quando este modelo tiver atividade.",
  "model.unranked": "Sem classificação no uso do NovaCode da última semana",
  "model.ranked": "Classificado em #{{rank}} no uso do NovaCode da última semana",
  ...
  "model.noCurrentUsage": "Sem uso do NovaCode na janela de dados atual.",
  ...
  "model.overviewDescription": "Tokens recentes do NovaCode, usuários únicos e posição de mercado.",
  "model.noSummaryTitle": "Sem resumo de uso",
  "model.noSummaryDescription": "Este modelo ainda não tem linhas de uso do NovaCode.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume diário de tokens do NovaCode na janela recente de dois meses.",
  ...
  "model.usersDescription": "Usuários únicos diários do NovaCode na janela recente de dois meses.",
  ...
  "model.efficiencyDescription": "Custo, comportamento de cache e formato médio da sessão do NovaCode.",
  ...
  "model.noGeoDescription": "Nenhuma linha geográfica do NovaCode correspondeu a este modelo.",
  "model.peersDescription": "Modelos próximos por volume recente de tokens do NovaCode.",
