...
const en = {
  "app.title": "AI Model Usage Rankings | NovaCode Data",
  "app.description":
    "Explore NovaCode usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "NovaCode Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star NovaCode on GitHub",
  "header.github": "GitHub",
  "header.tryNovaCode": "Try NovaCode",
  ...
  "home.topModelsDescription": "Usage of models across NovaCode.",
  ...
  "home.uniqueUsersDescription": "Daily unique NovaCode users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | NovaCode Data",
  "lab.description":
    "Compare {{lab}} models used in NovaCode, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent NovaCode usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in NovaCode",
  ...
  "lab.shareOfUsage": "{{share}} of recent NovaCode usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | NovaCode Data",
  "model.description":
    "View {{model}} NovaCode usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. NovaCode usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's NovaCode usage",
  "model.ranked": "Ranked #{{rank}} across last week's NovaCode usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No NovaCode usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no NovaCode usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.noGeoDescription": "No NovaCode geo rows matched this model.",
  "model.peersDescription": "Nearby models by recent NovaCode token volume.",
