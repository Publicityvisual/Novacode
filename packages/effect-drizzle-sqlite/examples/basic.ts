...
class Database extends Context.Service<Database, DatabaseShape>()("@novacode/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@novacode/example/UserStore") {
