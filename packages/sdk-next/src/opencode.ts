import { NovaCode } from "@novacode-ai/client/effect"
...
import { createEmbeddedRoutes } from "@novacode-ai/server/routes"
import { Context, Effect, Layer, Scope } from "effect"
import { FetchHttpClient, HttpRouter, HttpServer } from "effect/unstable/http"

export const create = Effect.fn("NovaCode.create")(function* () {
  ...
  const client = yield* NovaCode.make({ baseUrl: "http://novacode.local" }).pipe(
...
export class Service extends Context.Service<Service, Interface>()("@novacode-ai/sdk-next/NovaCode") {}
