...
- Effect plugins import `@novacode-ai/plugin/v2/effect`, not `@novacode-ai/core`.
- Public domain values use generated `@novacode-ai/sdk` types.
...
- Define `PluginHost` domain capabilities in `@novacode-ai/plugin/v2/effect`.
