...
import compareVideo from "../../asset/lander/novacode-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/novacode-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="novacode:auth" content={loggedin() ? "true" : "false"} />
