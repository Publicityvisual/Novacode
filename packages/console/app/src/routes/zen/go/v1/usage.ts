...
import { and, Database, eq, isNull } from "@novacode-ai/console-core/drizzle/index.js"
import { BillingTable, LiteTable } from "@novacode-ai/console-core/schema/billing.sql.js"
    ...
    return new Response(
      JSON.stringify({
        ...
        error: {
          ...
          message: "NovaCode Go subscription required.",
        },
      }),
      {
        status: 403,
