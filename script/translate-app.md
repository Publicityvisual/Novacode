...
- Preserve technical terms and artifacts exactly: NovaCode, API names, identifiers, code, commands, flags, paths, URLs, versions, error messages, config keys, and placeholder tokens.
