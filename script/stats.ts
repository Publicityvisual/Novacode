...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/novacode/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/novacode...\n")
...
console.log("Fetching npm all-time downloads for novacode-ai...\n")
const npmDownloads = await fetchNpmDownloads("novacode-ai")
