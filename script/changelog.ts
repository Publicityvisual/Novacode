...
Generates UPCOMING_CHANGELOG.md by running the novacode changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for novacode run (default: low)
      --quiet            Suppress novacode command output unless it fails
